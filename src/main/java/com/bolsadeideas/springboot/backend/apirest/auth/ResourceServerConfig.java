...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api-cliente/clientes", "/api-cliente/clientes/page/**", "/api-cliente/uploads/img/**", "/images/**").permitAll()
                /*.antMatchers(HttpMethod.GET, "/api-cliente/clientes/{id}").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api-cliente/clientes/upload").hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.GET, "/api-regiones/regiones").hasRole("ADMIN")
